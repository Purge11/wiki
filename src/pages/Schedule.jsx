            ...
            <div class="container d-flex justify-content-center">
                ...
                <li class="list-group-item d-flex justify-content-center bg-white text-danger">The Event times are GMT+1</li>
                    ...
                    <ul class="list-group mt-5">
                        ...
                        <li class="list-group-item d-flex justify-content-center">17:30</li>
                    ...
                    <ul class="list-group mt-5">
                        ...
                        <li class="list-group-item d-flex justify-content-center">15:30</li>
                        <li class="list-group-item d-flex justify-content-center">20:30</li>
                        <li class="list-group-item d-flex justify-content-center">22:00</li>
                    ...
                    <ul class="list-group mt-5">
                        ...
                        <li class="list-group-item d-flex justify-content-center">22:30</li>
                        <li class="list-group-item d-flex justify-content-center">01:45</li>

                    </ul>
                    <ul class="list-group mt-5">
                        <li class="list-group-item d-flex justify-content-center bg-primary  text-white">[Act4 World Boss Schedule]</li>
                        <li class="list-group-item d-flex justify-content-center">14:00</li>
                        <li class="list-group-item d-flex justify-content-center">16:20
                        </li>
                        <li class="list-group-item d-flex justify-content-center">23:10</li>
