            ...
            <div class="container">
                <div class="row">
                    ...
                    <div className='mt-5'>
                        ...
                        <br/>
                        You will be able to use only Cylloan spring water. (Act4 rules) After the boss
                        die monsters will disappear and you will get your reward. (Everyone who hitted
                        to boss.)
                        <br/>
                        After the boss die, a PvP event will start! Angels vs Demons, the first faction
                        who will get 250 kills will win the PvP Event, their rewards will be 100k
                        ...
                        - Gold Box
                        <br/>
                        - Adventurer Backpack (30 days)
                        <br/>
                        - Gold Nugget
                        <br/>
                        - 14th Anniversary Kangaroo Mount
                        <br/>
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <p class="item-effect-shell">
                                        ...
                                        <br/>
                                        - The fishing experience points you recive are increased by 5%
                                    </p>
