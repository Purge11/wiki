...
<h4 className="nosvoid-color ">Discord RPC</h4>
</div>
...
<img src="asset/feature/feature1.png" alt=""/>
                    ...
                    <div className="d-flex justify-content-center mt-5 pt-5">
                        ...
                        <h4 className="nosvoid-color ">CD on skills</h4>
                    </div>
                  
                    <div className="d-flex justify-content-center">
                    <p className="nosvoid-color">The CD on skills will have a new feature, the bar will show the seconds missing for the skill to be avaiable again.
Are your friends asking how many seconds are missing for your buff? Now you know!</p>
                    ...
                    <div className="d-flex justify-content-center mt-5 pt-5 ">
                        ...
                        <h4 className="nosvoid-color ">Searchbar Inventory</h4>
                    </div>
                   
                    <div className="d-flex justify-content-center mt-2">
                    <p className="nosvoid-color">The search bar is a new feature, that will make the item search easier. Are you looking for something in particular?
