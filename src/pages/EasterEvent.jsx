    ...
    return (
        <div className='easterevent'>
            <div className="container">
                ...
                -You can buy Chicken Queen raid seal from Raid Seal Npc (400k)
                <br />
                -This raid can be done with 15x players.
                <br />
                -The best specialists to do this raids are Jajamaru, Pajama Sp and every other with bleedings skills (in %, not in damages).
                <br /><br />
                <th scope="col">
                    Chicken Queen box info:
                </th>
                ...
                <h3><b>Mad March Hare Raid</b></h3>
                -You can buy Mad March Hare raid seal from Raid Seal Npc (500k)
                <br />
                -This raid can be done with 15x players.
                <br />
                -Need some shadow resistance, because of the bomb's skills of the Boss.
                <br /><br />
                <th scope="col">
                    Mad March Hare box info:
                </th>
                ...
                <br />
                <b>Exchange:</b><br />
                -Change your 10 Reg Eggs to 5 Green Eggs<br />
                -Change your 10 Yellow Eggs to 5 Reg Eggs<br />
                -Change your 10 Green Eggs to 5 Yellow Eggs<br />
                -Change your 2 Golden Carrot to 1 Silver Carrot<br />
                ...
                <h3><b>Mad March Hare NPC</b>&nbsp;<i>for quests</i></h3>
                On this NPC you can do 4 quests:<br />
                <b>1-.</b> Help us get rid of the Mad March!<br />
                &nbsp;
                ...
                <b>2-.</b> Kill the Chicken Queen and her children!<br />
                &nbsp;
                <div className='borderoRW'>
                    <d className="name">Rewards:<br /></d>
                    x1 Gummy Frog<br />
                ...
                <b>3-.</b> Welcome to the Easter Event!<br />
                &nbsp;
                <div className='borderoRW'>
                    <d className="name">Rewards:<br /></d>
                    x15 Red Eggs<br />
                ...
                <b>4-.</b> We need a big and strong hunter for this quest. <b>MARATHON QUEST</b><br />
                &nbsp;
                <div className='borderoRW'>
                    <d className="name">Rewards:<br /></d>
                    x20 Special Easter Box<br />
                </div><br />

                <br /><br /><br />

                <h1 className="nosvoid-color d-flex justify-content-center">New Stuff!</h1>
                <p className="d-flex justify-content-center">With this event we have introduced a lot of amazing new things!</p>
                    ...
                    <div className='mt-8'>
                        <table className="table">
                            <thead>
                                ...
                                <d className="item-effect-shell">
                                    - There is 5% chance that picked up gold will be doubled.
                                    <br />
                        ...
                        <table className="table">
                            <thead>
                                ...
                                <d className="item-effect-shell">
                                    ...
                                    <br />
                                    - You ate 18 full buckets of Tenders and now you are full.
                                </d>
                                <br />
                                <d className="white-color">___________________________________________________________________________________________</d>
                            </thead>
