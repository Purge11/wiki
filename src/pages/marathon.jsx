    ...
    return (
        <div className="title">
            <div className="container">
                ...
                Marathon Quest" and "Fernon Marathon Quest".
                <br/><br/>
                ...
                <br/>
                You also will be able to get Final raids "Final Zenas Marathon Quest", "Final
                Erenia Marathon Quest" and "Final Fernon Marathon Quest".
                <br/><br/>
                                ...
                                <div className="flip-card-front">
                                    ...
                                    <div className="card-body ">
                                        ...
                                        <p className="card-text item-effect">
                                            ...
                                            - When raid is finished, there's a 3% chance that box drops second time.</p>
                                    </div>
